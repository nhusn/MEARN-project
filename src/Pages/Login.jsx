                                ...
                                <div className='form-div'>
                                    <form onSubmit={(e)=>handleShopLogin(e)}>
                                        <div className='login-inputs'>
                                            <input type="text" placeholder='Email ID' value={shopDetail.email} onChange={(e)=>setShopDetails({...shopDetail,email:e.target.value})} required />
                                            <label ><i className="fa-solid fa-envelope"></i></label>
                                            <div className='login-form-underline'></div>
                                        </div>
                                        <div className='login-inputs mt-5'>
                                            <input type="password" placeholder='Password'  value={shopDetail.password} onChange={(e)=>setShopDetails({...shopDetail,password:e.target.value})} required />
