    ...
    <div className="Service-page">
      ...
      {isCustomerLogged ? (
        ...
        <Row style={{ margin: "auto" }}>
          <Col className="service-main-div">
            <Row className="cardOfService">
              ...
              <Col style={{ zIndex: "1" }} lg={6}>
                <div className="dot mt-3">
                  <p>Clutch Cable / Wire, Release Bearing / Clutch Cylinder</p>
                </div>
                <div className="dot">
                  <p>Clutch Set OES (Clutch Plate + Pressure Plate) Replacement</p>
                </div>
              </Col>
              <Col></Col>
              <Col style={{ zIndex: "1" }} lg={4}>
                ...
                <div className="dot">
                  <p>Clutch Oil, Gear Oil Additional</p>
                </div>
                <div className="dot">
                  <p>Opening & Fitting of Clutch Set</p>
                </div>
              </Col>
            </Row>
            ...
            <Row className="cardOfService mt-5">
              ...
              <Col style={{ zIndex: "1" }} lg={6}>
                <div className="dot mt-3">
                  <p>Clutch Set, Clutch Bearing, Clutch Cable / Wire,Clutch Cylinder</p>
                </div>
                <div className="dot">
                  <p>Automatic Transmission Clutch rates may vary</p>
                </div>
              </Col>
              <Col></Col>
              <Col style={{ zIndex: "1" }} lg={4}>
                <div className="dot mt-3">
                  <p>Flywheel OES Replacement</p>
                </div>
                <div className="dot">
                  <p>Spare Part Price Only</p>
                </div>
                <div className="dot">
                  <p>Free Pickup & Drop</p>
                </div>
            ...
            <Row className="cardOfService mt-5">
              ...
              <Col style={{ zIndex: "1" }} lg={6}>
                <div className="dot mt-3">
                  <p>Inner Door Latch Mechanism Part Replacement</p>
                </div>
                <div className="dot">
                  <p>Outside Door Handle Cost Additional ( If Needed )</p>
                </div>
              </Col>
              <Col></Col>
              <Col style={{ zIndex: "1" }} lg={4}>
                ...
                <div className="dot">
                  <p>OES Spare Part Cost Only</p>
                </div>
                <div className="dot">
                  <p>Paint/Trim Cost Additional</p>
                </div>
              </Col>
            </Row>
            ...
            <Row className="cardOfService mt-5">
              ...
              <Col style={{ zIndex: "1" }} lg={6}>
                ...
                <div className="dot">
                  <p>Every 6 Months (Recommended)</p>
                </div>
                <div className="dot">
                  <p>Rubbing with 3M™ Compound</p>
                </div>
              </Col>
              <Col></Col>
              <Col style={{ zIndex: "1" }} lg={4}>
                <div className="dot mt-3">
                  <p>Tyre Dressing and Alloy Polishing</p>
                </div>
                <div className="dot">
                  <p>3M™ Wax Polishing</p>
                </div>
              </Col>
            </Row>
            ...
            <Row className="cardOfService mt-5">
              ...
              <Col style={{ zIndex: "1" }} lg={6}>
                <div className="dot mt-3">
                  <p>Opening & Fitting of Front Bumper</p>
                </div>
                <div className="dot">
                  <p>Front Bumper Replacement (Black Colour)</p>
                </div>
                <div className="dot">
                  <p>Paint Cost Addtional</p>
                </div>
              </Col>
              <Col></Col>
              <Col style={{ zIndex: "1" }} lg={4}>
                <div className="dot mt-3">
                  <p>Brackets, Grills, Cladding Additional</p>
                </div>
                <div className="dot">
                  <p>Free Pickup & Drop</p>
                </div>
