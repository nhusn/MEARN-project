      ...
      <div style={{ padding: "50px" }}>
        ...
        <Row style={{ margin: "auto", color: "white" }} className="px-5">
          <Col lg={7}>
            ...
            <p style={{ fontSize: "18px" }}>
              After you submit the form, a representative will call you back with the information
            </p>
          </Col>
          <Col></Col>
        </Row>
        {isCustomerLogged ? (
          ...
          <Row style={{ margin: "auto" }} className="p-5">
            ...
            <Col lg={6} className="forms-col">
              <label htmlFor="uname">YOUR MOBILE NO</label>
              <br />
              <input
                type="number"
                minLength={10}
                ...
                value={callRequest.number}
                onChange={(e) => setCallRequest({ ...callRequest, number: e.target.value })}
                required
              />
              <div className="form-underline"></div>
            </Col>
        ...
        <Row style={{ margin: "auto" }} className="px-5 mt-3">
          <Col lg={6} className="forms-col">
            ...
            <input
              ...
              required
              min={date}
              value={callRequest.date}
              onChange={(e) => setCallRequest({ ...callRequest, date: e.target.value })}
            />
            <div className="form-underline"></div>
          </Col>
          <Col lg={6} className="forms-col">
            ...
            <input
              type="time"
              name="uname"
              value={callRequest.time}
              onChange={(e) => setCallRequest({ ...callRequest, time: e.target.value })}
              required
            />
            <div className="form-underline"></div>
          </Col>
        ...
        <Row style={{ margin: "auto" }} className="px-5 mt-5">
          <Col lg={12} className="forms-col">
            <label htmlFor="uname">YOUR MESSAGE</label>
            <br />
            <textarea
              style={{ backgroundColor: "transparent", width: "100%", border: "none", outline: "none", color: "white" }}
              type="text"
              name="uname"
              placeholder="Describe Your Problem"
              value={callRequest.message}
              onChange={(e) => setCallRequest({ ...callRequest, message: e.target.value })}
              required
            />
            <div style={{ width: "98%" }} className="form-underline"></div>
          </Col>
        </Row>
        <div className="p-5 callrequestbutton">
          <button onClick={(e) => handleCallRequest(e)}>SEND MESSAGE</button>
        </div>
      </div>
      <Footer />
      <ToastContainer />
