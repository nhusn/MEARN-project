            ...
            <Row style={{ margin: "auto" }} className='Price-book'>
                <Col lg={8}>
                    <div>
                        ...
                        <p>Our team understands that cars need extra special care and attention to perform at their peak on the road, and we’ve got the tools and parts to make this happen.</p>
